...
query = (hourly_sales_df
    ...
    .option("checkpointLocation", f"{checkpoint_dir}/hourly_sales_2" )  # Checkpoint path
...
# DBTITLE 1,Task 3.4: Enrich Streaming Data with Static Franchise Information
...
enriched_stream = (streaming_df
    .join(franchises_df ,
          "franchiseID"  )   # DataFrame to join and join column
    .select(
        col("dateTime"),
        col("franchiseID"),
